...
let range:any = document.getElementById('display-password-length');
let passwordOutPut:any = document.getElementById('password-output');



// checkbox 
const lowercase:any = document.getElementById('lowercase');
const uppercase:any = document.getElementById('uppercase');
const number:any = document.getElementById('number');
const symbole:any = document.getElementById('symbole');
...
function generatePassword(){
    ...
    if(symbole.checked) data.push(...dataSymbole)
